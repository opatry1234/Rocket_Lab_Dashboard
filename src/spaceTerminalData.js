  ...
  'spacex': [
    {
      ...
      ll2Name: 'Falcon 9',
      wikiTitle: 'Falcon_9',
      heroImage: '/vehicles/falcon-9.jpg',
    ...
    },
    {
      ...
      wikiTitle: 'Falcon_Heavy',
      heroImage: '/vehicles/falcon-heavy.jpg',
    ...
    },
    {
      ...
      type: 'in-production',
      ll2Name: 'Starship',
      wikiTitle: 'SpaceX_Starship',
      heroImage: '/vehicles/starship.jpg',
      ...
      timeline: [
        { year: '2019', label: 'Starship Mk1 prototype unveiled at Boca Chica' },
        { year: '2021', label: 'SN15 completes first successful high-altitude test and landing' },
        { year: '2022', label: 'Full Starship stack assembled; Super Heavy booster static fires' },
        { year: '2023', label: 'IFT-1 and IFT-2 — first integrated flights and stage separation' },
        { year: '2024', label: 'IFT-3 through IFT-6 — orbit, splashdowns, and booster catch' },
        { year: '2025', label: 'Repeat booster catches; preparing first commercial payloads', current: true },
      ],
      stats: [
        { label: 'Payload to LEO', value: '150,000 kg', sub: 'fully reusable' },
        { label: 'Height', value: '121 m', sub: 'full stack' },
        { label: 'Engines', value: '33 Raptors', sub: 'Super Heavy booster' },
        { label: 'Reusability', value: 'Full Stack', sub: 'booster + ship' },
      ],
      overallPct: 72,
    },
  ],
  'rocket-lab': [
    {
      ...
      ll2Name: 'Electron',
      wikiTitle: 'Electron_(rocket)',
      heroImage: '/vehicles/electron.jpg',
  ...
  'blue-origin': [
    {
      ...
      type: 'usable',
      ll2Name: 'New Shepard',
      wikiTitle: 'New_Shepard',
      heroImage: '/vehicles/new-shepard.jpg',
    ...
    },
    {
      ...
      ll2Name: 'New Glenn',
      wikiTitle: 'New_Glenn',
      heroImage: '/vehicles/new-glenn.jpg',
  ...
  'firefly': [
    {
      ...
      type: 'usable',
      ll2Name: 'Alpha',
      wikiTitle: 'Firefly_Alpha',
      heroImage: '/vehicles/firefly-alpha.jpg',
    ...
    },
    {
      ...
      timeline: [
        { year: '2023', label: 'Elytra program announced; in-space transportation concept defined' },
        { year: '2024', label: 'Blue Ghost lunar lander begins flight preparation' },
        { year: '2025', label: 'Blue Ghost CLPS mission success; validates deep space heritage', current: true },
        { year: '2026', label: 'Elytra initial orbital operations targeting' },
        { year: '2027', label: 'Commercial hosted payload and transfer services begin' },
      ],
      stats: [
        { label: 'Mission Profile', value: 'Orbital Transfer', sub: 'and hosted payload' },
        { label: 'Reusability', value: 'Yes', sub: 'on-orbit operations' },
        { label: 'Power', value: 'Solar', sub: 'electric propulsion' },
        { label: 'Heritage', value: 'Blue Ghost', sub: 'lunar lander tech' },
      ],
      overallPct: 45,
    },
  ],
  'vast': [
    {
      ...
      timeline: [
        { year: '2021', label: 'Vast founded; commercial space station vision established' },
        { year: '2022', label: 'Haven-1 concept announced; SpaceX partnership discussions begin' },
        { year: '2023', label: 'Falcon 9 launch agreement secured; station design advances' },
        { year: '2024', label: 'Haven-1 manufacturing underway; crew interface qualified', current: true },
        { year: '2025', label: 'Station launch targeting; first crewed Dragon mission planned' },
        { year: '2026', label: 'Operational commercial station missions; Haven-2 planning' },
      ],
      stats: [
        { label: 'Pressurized Volume', value: '~90 m³', sub: 'habitable space' },
        { label: 'Crew Capacity', value: '4', sub: 'visiting crew' },
        { label: 'Launch Vehicle', value: 'Falcon 9', sub: 'SpaceX' },
        { label: 'Target Launch', value: '2025–26', sub: 'estimated' },
      ],
      overallPct: 62,
    },
  ],
  'relativity': [
    {
      ...
      timeline: [
        { year: '2021', label: 'Terran R announced; fully reusable medium-lift vision revealed' },
        { year: '2022', label: 'Stargate 2 printing system operational; structure test articles begin' },
        { year: '2023', label: 'LC-16 launch site lease secured at Cape Canaveral' },
        { year: '2024', label: 'Aeon R engine testing advances; vehicle structure manufacturing underway', current: true },
        { year: '2025', label: 'Engine qualification push; ground systems construction at LC-16' },
        { year: '2026', label: 'First launch targeting', current: false },
      ],
      stats: [
        { label: 'Payload to LEO', value: '20,000 kg', sub: 'expendable' },
        { label: 'Height', value: '~66 m', sub: 'full stack' },
        { label: 'Engine', value: 'Aeon R', sub: 'LOX/methane' },
